    ...
    >
        <div class="mb-6">
            ...
            <p class="mt-1 text-sm text-stone-500 dark:text-stone-400">
                Record money coming in or going out of the family balance.
            </p>
        </div>
        <form
        ...
        >
            ...
            <div class="space-y-2">
                ...
                <select
                    ...
                    class="h-10 w-full rounded-md border border-stone-300 bg-white px-3 text-sm text-stone-900 transition outline-none focus:border-emerald-600 focus:ring-2 focus:ring-emerald-600/20 dark:border-stone-700 dark:bg-stone-950 dark:text-stone-100"
                    required
                >
                ...
                >
                    No {{ transactionForm.type }} categories are available yet.
                </p>
            </div>
            <div class="space-y-2">
                <label
                ...
                <input
                    ...
                    step="0.01"
                    placeholder="0.00"
                    class="h-10 w-full rounded-md border border-stone-300 bg-white px-3 text-sm text-stone-900 transition outline-none placeholder:text-stone-400 focus:border-emerald-600 focus:ring-2 focus:ring-emerald-600/20 dark:border-stone-700 dark:bg-stone-950 dark:text-stone-100"
                    required
                />
                <p
